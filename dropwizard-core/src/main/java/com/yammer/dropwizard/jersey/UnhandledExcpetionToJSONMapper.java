 ...
 */
@Provider
public class UnhandledExcpetionToJSONMapper implements ExceptionMapper<Exception> {

    private static final Logger LOGGER = LoggerFactory.getLogger(UnhandledExcpetionToJSONMapper.class);
    ...
    private String invalidEntityJSON(InvalidEntityException exception) {
        ErrorInfo errorInfo = new ErrorInfo(exception.getMessage(), exception.getErrors());

        try {
            return MAPPER.writeValueAsString(errorInfo);
        } catch (JsonProcessingException e) {
            LOGGER.error("invalidEntityJSON() Failed to serialize error", e);
